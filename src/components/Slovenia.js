...
<li>Original Passport with at least 6 months validity and minimum 3 blank pages + all old passports if any;</li>
    ...
    <a href='https://www.gov.si/en/registries/services/e-visa/' target='_blank' rel='noopener noreferrer'>Apply for Visa</a>
            <br></br>
            <br></br>
            <a href='https://www.gov.si/en/representations/embassy-new-delhi/visa-information/' target='_blank' rel='noopener noreferrer'>Book a Visa appointment</a>
        </div>
    );
}
