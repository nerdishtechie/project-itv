...
function Hungary(){
    return(
        <div>
            ...
            <a href='https://konzinfo.mfa.gov.hu/en/visa-application-forms' target='_blank' rel='noopener noreferrer'>Apply for Visa</a>
            <br></br>
            <br></br>
            <a href='https://visa.vfsglobal.com/ind/en/hun/book-an-appointment' target='_blank' rel='noopener noreferrer'>Book a Visa appointment</a>
        </div>
    );
}
